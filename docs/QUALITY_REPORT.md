...
| Status | Check | Detail |
| --- | --- | --- |
| PASS | Method summary coverage | 235/235 methods use LLM summaries; 0 methods use fallback summaries. |
| PASS | Narrative overview | see-code 是一个静态代码仓库分析工具，扫描指定目录下的源代码文件，提取模块、方法、类、资源及调用关系图，生成结构化工程文档（Markdown 和 JSON），并可选通过 LLM 补充方法语义标签。 |
...
| PASS | Document size balance | Largest document is 49470 characters. |
