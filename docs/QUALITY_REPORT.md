...
| Status | Check | Detail |
| --- | --- | --- |
| PASS | Method summary coverage | 113/113 methods use LLM summaries; 0 methods use fallback summaries. |
| PASS | Narrative overview | see-code 是一个静态代码分析工具，扫描指定代码仓库，提取模块、方法、类、资源及调用关系图，并通过启发式规则和可选的 LLM 语义分析生成结构化文档和统计信息。 |
...
| PASS | Document size balance | Largest document is 39768 characters. |
