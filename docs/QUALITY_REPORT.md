...
| Status | Check | Detail |
| --- | --- | --- |
| PASS | Method summary coverage | 248/248 methods use LLM summaries; 0 methods use fallback summaries. |
| PASS | Narrative overview | 该工具分析指定代码仓库，提取模块、方法、类、资源和关系图，并生成工程文档（Markdown 文件）和结构化 JSON 结果。 |
...
| PASS | Document size balance | Largest document is 52832 characters. |
