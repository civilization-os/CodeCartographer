...
| src/cli/analyzeCommand.ts | typescript | 2298 |
| src/cli/args.ts | typescript | 4673 |
| src/cli/doctorCommand.ts | typescript | 3170 |
| src/cli/initCommand.ts | typescript | 2058 |
| src/cli/interactiveCommand.ts | typescript | 5174 |
| src/cli/modelCommand.ts | typescript | 4477 |
| src/config/projectConfig.ts | typescript | 2281 |
...
| tests/analyzeRepo.test.ts | typescript | 23710 |
| tests/cli.test.ts | typescript | 5060 |
