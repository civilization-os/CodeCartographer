...
| README.md | markdown | 4281 |
| scripts/secret-scan.mjs | javascript | 1382 |
| SPEC.md | markdown | 8517 |
...
| src/output/resultJsonWriter.ts | typescript | 5218 |
...
| tests/analyzeRepo.test.ts | typescript | 6029 |
