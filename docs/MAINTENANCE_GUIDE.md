...
| File | Language | Bytes |
| --- | --- | --- |
| evaluations/spring-petclinic.md | markdown | 3719 |
...
| src/docs/semanticAggregator.ts | typescript | 8596 |
...
| src/parser/javaStructureParser.ts | typescript | 22850 |
...
| tests/analyzeRepo.test.ts | typescript | 12460 |
